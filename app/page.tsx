...
function IssueCard({ project, issue, severity, lastScan, healthScore }: any) {
    ...
    <div className="bg-white rounded-lg p-4 shadow hover:shadow-lg transition-shadow">
      ...
      {project.domain && (
        <a
          ...
          className="w-full block px-3 py-2 text-sm text-center bg-light-gray text-gray-700 rounded hover:bg-gray-200"
        >
          View Site
        </a>
      )}
